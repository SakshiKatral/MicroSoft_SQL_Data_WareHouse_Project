...
BEGIN
    BEGIN TRY
		...
		--Truncating Table: silver.crm_customer_info';
		TRUNCATE TABLE silver.crm_customer_info;
    --Inserting Data Into: silver.crm_customer_info';
    ...
    --loading silver.crm_product_info
		--Truncating Table: silver.crm_product_info';
		TRUNCATE TABLE silver.crm_product_info;
		--Inserting Data Into: silver.crm_product_info';
