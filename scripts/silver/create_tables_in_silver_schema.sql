--Drop 'silver.crm_customer_info' table if present 
...
--Drop 'silver.crm_product_info' table if present 
...
--Drop 'silver.crm_sales_details' table if present 
...
--Drop 'silver.erp_customer_az12' table if present 
...
--Drop 'silver.erp_loc_a101' table if present 
...
--Drop 'silver.erp_px_cat_g1v2' table if present 
